...
namespace Content.Stellar.Shared.CosmicCult.Abilities;
...
public abstract class SharedCosmicShiftSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CosmicCultComponent, EventCosmicShift>(OnShiftAbility);
        SubscribeLocalEvent<CosmicShiftedComponent, EventCosmicReturn>(OnReturnAbility);

        SubscribeLocalEvent<CosmicCultComponent, CosmicShiftStartDoAfter>(OnShiftStartDoAfter);
    ...
    private void OnShiftAbility(Entity<CosmicCultComponent> ent, ref EventCosmicShift args)
    {
    ...
    protected virtual void OnShiftStartDoAfter(Entity<CosmicCultComponent> ent, ref CosmicShiftStartDoAfter args)
    {
    ...
    public void ShiftToDestination(EntityUid ent, MapCoordinates destination)
    {
        ...
        _entityTimer.SpawnMethodTimer(TimeSpan.FromSeconds(2.5), () => OnShiftMove(ent, destination)); // I hate doing this
        _entityTimer.SpawnMethodTimer(TimeSpan.FromSeconds(4.6), () => OnShiftEnd(ent)); // I hate doing this
    }
