...
public sealed class CosmicCultRuleSystem : GameRuleSystem<CosmicCultRuleComponent>
{
    ...
    [Dependency] private readonly CosmicBreachSystem _breach = default!;
    ...
    [Dependency] private readonly SharedCosmicShiftSystem _cultShift = default!;
    ...
    private readonly SoundSpecifier _finaleSound = new SoundPathSpecifier("/Audio/_ST/CosmicCult/tier-finale.ogg");
    ...
    private readonly ResPath _mapPath = new("Maps/_ST/Other/the-cosmic-dark.yml"); // This map relies on Stellar-exclusive features that exist outside the Cosmic Cult license. You must make a new map when porting Cosmic Cult.
    private static readonly EntProtoId<WeatherStatusEffectComponent> CosmicDarkWeather = "StellarWeatherDetailFog";
    ...
    protected override void Added(EntityUid uid, CosmicCultRuleComponent component, GameRuleComponent gameRule, GameRuleAddedEvent args)
    {
        ...
        _weather.TrySetWeather(map.Value.Comp.MapId, CosmicDarkWeather, out _);
        component.StationGrid = grid;
        component.VoidMapId = map.Value.Comp.MapId;
    ...
    private void CultWin(EntityUid uid, CosmicCultRuleComponent component)
    {
        ...
        component.WinType = CultWinType.CultWin;
    ...
    private void OnMobStateChanged(Entity<CosmicCultComponent> ent, ref MobStateChangedEvent args)
    {
        ...
        cult.Comp.WinType = CultWinType.CrewWin;
    ...
    public void IncrementCultistProgress(Entity<CosmicCultComponent> ent, int amount = 0)
    {
