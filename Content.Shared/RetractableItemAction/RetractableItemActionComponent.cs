...
public sealed partial class RetractableItemActionComponent : Component
{
    ...
    /// </summary>
    [DataField]
    public SoundSpecifier? SummonSounds; // Stellar - SoundSpecifier, not SoundCollection.

    /// <summary>
    /// Sound collection to play when the summoned item is retracted back into the action.
    /// </summary>
    [DataField]
    public SoundSpecifier? RetractSounds; // Stellar - SoundSpecifier, not SoundCollection.
